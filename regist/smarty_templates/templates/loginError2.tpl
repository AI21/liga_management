...
<title>リーガ東海&nbsp;チーム情報確認 [ログインエラー]</title>
</head>

<body>

<div class="teamname" style="font-size:30px;text-align:center;">リーガ東海 {$teamName}</div>
...
<p style="text-align:center;"><a href="./login2.php">ログイン画面へ</a></p>
