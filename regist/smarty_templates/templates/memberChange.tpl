...
<div style="text-align:center;">
  <div class="teamname" style="font-size:24px;">{$rarryDataArray.rarry_name}&nbsp;{$rarryDataArray.rarry_sub_name}&nbsp;{$subName}変更</div>
...
{if $readMode ne 'readOnly'}
        <td style="padding-left:20px;"><input type="text" size="5" maxlength="2" name="number" value="{$number}" class="imehan1" />{$errorValue.number}</td>
{else}
...
{/if}
      ...
      <tr>
        <th style="">読みカナ</th>
        <td style="">
          <span style="font-size:10px;">姓</span><input type="text" size="15" maxlength="16" name="kanaFirst" value="{$kanaFirst|replace:"amp;":""}" class="imezen" />&nbsp;
          <span style="font-size:10px;">名</span><input type="text" size="15" maxlength="16" name="kanaSecond" value="{$kanaSecond|replace:"amp;":""}" class="imezen" />{$errorValue.kana}
        </td>
      </tr>
      <tr>
        <th style="">ポジション</th>
      ...
      <tr>
        <th style="">身長</th>
        <td style="padding-left:20px;">
          <input type="text" size="5" maxlength="3" name="tall" value="{$tall}" class="imehan1" />&nbsp;cm{$errorValue.tall}
        </td>
      </tr>
      <tr>
        <th style="">誕生日</th>
        <td style="padding-left:20px;">
          ...
          <input type="text" name="bd_y" size="4" maxlength="4" value="{$bd_y}" class="imehan1" />年
          <select name="bd_m">
      ...
      <tr>
        <td colspan="4" style="padding:10px 0;text-align:center;background-color:#FFFFFF;">
          <input type=submit value="　選手情報変更確認　" />
