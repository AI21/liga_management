...
function retrievalPlayer($connect, $nextRarryId, $nextSeason, $preRarryId, $preSeason, $teamId, $retrievalData) {
    ...
    $sql = "SELECT " .
           ...
           "       CASE WHEN PRELTI.`t_name` IS NULL then '̤��°' ELSE PRELTI.`t_name` END preTeamName, " .
           "       CASE WHEN NEXTLTI.`t_name` IS NULL then '̤��°' ELSE NEXTLTI.`t_name` END nextTeamName " .
