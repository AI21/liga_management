...
<link rel="stylesheet" href="../regist/css/base.css" type="text/css" media="screen" />
<link rel="stylesheet" href="../regist/css/transfer.css" type="text/css" media="screen" />
<link rel="stylesheet" href="../regist/css/simplePagination.css" type="text/css" media="screen" />

<title>{$rarryDataArray.rarry_name}&nbsp;{$rarryDataArray.rarry_sub_name}&nbsp;選手検索・移籍登録</title>
</head>
<body>
<div id="mainContents">
	<div id="headerArea"><a href="memberTransfer.php">最初からやり直す</a>&nbsp;|&nbsp;<a href="http://liga-tokai.com/league/">リーガ東海HOME</a></div>
	<div id="titleArea">{$rarryDataArray.rarry_name}&nbsp;{$rarryDataArray.rarry_sub_name}&nbsp;選手検索システム</div>
	<div id="teamDataArea">
		<div id="member-search">
			...
			<table id="memberfm" align="center">
				...
				<tr>
					...
					<td><input type="submit"  id="retrievalName" value="　選手検索　" /></td>
					<input type="hidden" name="mode" value="retrieval" />
					<input type="hidden" name="sts" value="" />
					</form>
				</tr>
				<tr>
					<th colspan="3">読みカナから検索（ひらがな・カタカナ）</th>
				</tr>
				<tr>
				<tr>
					<form name="membertaking" method="post" action="memberTransfer.php">
					...
					<td><input type="submit"  id="retrievalKana" value="　選手検索　" /></td>
					<input type="hidden" name="mode" value="retrieval" />
					<input type="hidden" name="sts" value="" />
					</form>
				</tr>
	...
	{if $mode == "retrieval"}
		...
		<table id="member" align="center">
			...
			<tr style="">
				...
				<td colspan="2" style="text-align:left;color:blue;font-weight:bold;">移籍可能です。</td>
					{else}
				<td style="">
...
<script type="text/javascript" src="../regist/js/jquery.simplePagination.js"></script>
